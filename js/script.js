...
// }
var nis = "299758";
var url5day = "http://dataservice.accuweather.com/forecasts/v1/daily/5day/"+ nis +"?apikey=CUIJALV2AY2W5LxbnZ4wjW6A9rHJbfjG";
// pocetak 5 day requesta
trazi.open('GET', url5day, true);
		trazi.onload = function(){
		if(this.status === 200){
			...
			trazi.send();
			// kraj 5 day requesta
			var url12hour = "http://dataservice.accuweather.com/forecasts/v1/hourly/12hour/"+ nis +"?apikey=CUIJALV2AY2W5LxbnZ4wjW6A9rHJbfjG";
			// pocetak 12 sati requesta
			trazi1.open('GET', url12hour, true);
			trazi1.onload = function(){
			if(this.status === 200){
